...
Keep the browser UUID alternatives in `airbridge/web/airbridge-transports.js` because firmware byte ordering and browser canonicalization have differed across builds.
