...
class BundleMatchesSourceTest(unittest.TestCase):
    def test_only_usb_deploy_assets_are_built(self) -> None:
        self.assertEqual(BOOTSTRAPS, ((ROOT / "web" / "bootstrap.js", 4096),))
...
class BundleIntegrationTest(unittest.TestCase):
    ...
    def test_container_and_digests_when_outputs_are_generated(self) -> None:
        ...
        raw = (ROOT / "dist/app-usb.html").read_bytes()
        container = (ROOT / "dist/app-usb.html.gz").read_bytes()
        ...
        for name, data in (("BOOTSTRAP", (ROOT / "web/bootstrap.js").read_bytes()), ("APP_USB_BUNDLE", container)):
        ...
        self.assertEqual({p.name for p in (ROOT / "dist").iterdir()}, {"app-usb.html", "app-usb.html.gz"})
        self.assertFalse((ROOT / "web/bootstrap-ble.js").exists())
    ...
    def test_freshness_is_false_when_an_artifact_is_missing_or_stale(self) -> None:
        ...
        for name in ("app-usb.html", "app-usb.html.gz", "digest.h"):
